package org.csu.petstore.order.aop;
...
import org.csu.petstore.order.annotation.LogAccount;
import org.csu.petstore.order.entity.Log;
import org.csu.petstore.order.service.LogService;
/*import org.csu.petstore.order.vo.AccountVO;
import org.csu.petstore.order.vo.AdminVO;*/
...
public class LogAspect {
    ...
    //定义切点 @Pointcut
    //在注解的位置切入代码
    @Pointcut("@annotation(org.csu.petstore.order.annotation.LogAccount)")
    public void logPointCutAccount(){
    }

    @Pointcut("@annotation(org.csu.petstore.order.annotation.LogAdmin)")
