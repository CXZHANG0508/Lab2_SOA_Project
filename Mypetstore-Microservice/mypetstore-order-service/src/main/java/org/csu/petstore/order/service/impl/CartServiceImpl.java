...
import org.csu.petstore.order.client.ProductServiceClient;
import org.csu.petstore.order.common.CommonResponse;
import org.csu.petstore.order.entity.Cart;
import org.csu.petstore.order.persistence.CartMapper;
...
public class CartServiceImpl implements CartService {
    ...
    public CommonResponse<List<CartItem>> getCartItemListByUserId(String userId) {
        ...
        for (Cart cart : cartList) {
            ...
            ItemVO itemVO = productServiceClient.getItem(cart.getItemId()).getData();
            cartItem.setItemVO(itemVO);
            cartItem.setInStock(itemVO.getQuantity());
