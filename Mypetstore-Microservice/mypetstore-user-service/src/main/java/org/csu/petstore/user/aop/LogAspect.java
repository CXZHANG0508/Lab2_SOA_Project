package org.csu.petstore.user.aop;
...
public class LogAspect {
    ...
    //定义切点 @Pointcut
    //在注解的位置切入代码
    @Pointcut("@annotation(org.csu.petstore.user.annotation.LogAccount)")
    public void logPointCutAccount(){
    }

    @Pointcut("@annotation(org.csu.petstore.user.annotation.LogAdmin)")
